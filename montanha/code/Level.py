...
from code.Const import COLOR_WHITE, MENU_OPTION, EVENT_ENEMY, WIN_HEIGHT, COLOR_GREE, COLOR_CYAN, EVENT_TIMEOUT
    ...
    def run(self, player_score : [int]):
        ...
        while True:
            ...
            for ent in self.entity_list:
                ...
                if ent.name == 'Player1':
                    self.level_text(14, f'Player1 - Health {ent.health} Score: {ent.score}', COLOR_GREE, (10, 20))

                if ent.name == 'Player2':
                    self.level_text(14, f'Player2 - Health {ent.health} Score: {ent.score}', COLOR_CYAN, (10, 35))

            # texto a ser printado na tela
            self.level_text(14, f' {self.name} - Timeout: {self.timeout / 1000}s', COLOR_WHITE, (10, 5))
